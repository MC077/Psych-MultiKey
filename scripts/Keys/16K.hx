...
function generateStaticArrows(player:Int) {
	var strumLineX:Float = ClientPrefs.data.middleScroll ? -315: 4;
	...
	for (i in 0...16)
	{
        ...
        if (ClientPrefs.data.middleScroll && player == 0) if (i > 7) babyArrow.x += 960; else babyArrow.x += 310;
